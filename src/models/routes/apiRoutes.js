...
const data = require('../dish.Model.js');

// 1. GET (Read All) - Routes for /dishes with optional filtering
...
// 2. POST (Create) - Routes for /dishes
...
// 3. PUT (Update Full Resource) - Routes for /dishes/:id
...
// 4. DELETE (Remove) - Routes for /dishes/:id
